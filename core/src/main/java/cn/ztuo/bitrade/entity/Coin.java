...
public class Coin {
    ...
    @Column(columnDefinition = "decimal(18,8) default 0.00 comment '人民币汇率'")
    ...
    @Column(columnDefinition = "decimal(18,8) default 0.00 comment '美元汇率'")
     ...
     * 提币阈值
     */
    @Column(columnDefinition = "decimal(18,8) comment '自动提现阈值'")
...
//    private Boolean isToken = false;
    ...
    @Column(columnDefinition = "decimal(18,8) default 0 comment '最小充币数量'")
    private BigDecimal minRechargeAmount = BigDecimal.ZERO;

    @Column(columnDefinition = "varchar(64) default null comment '主充值地址'")
    private String masterAddress;

    @Column(columnDefinition = "decimal(18,8) default 0 comment '单日最大提币量'")
